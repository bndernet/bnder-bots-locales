    ...
    static Localizations: TSLocalizationKeys = {
        task: {
            deadline_due(id: string, deadline: string, guildName: string, guildId: string, taskTitle: string): string {
                return `De deadline voor taak **${id}** ${taskTitle} is op ${deadline} in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>)`;
            },
            assigned_notification(guildName: string, guildId: string, id: string, taskText: string): string {
                return `Je bent toegewezen aan taak **${id}** ${taskText} in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>)`;
            },
            ...
            deadline_was_in_past(id: string, guildName: string, guildId: string, taskTitle: string): string {
                return `De deadline voor taak **${id}** ${taskTitle} is verlopen in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>)`;
            },
            repeat_notification(guildName: string, guildId: string, id: string, taskTitle: string): string {
                return `De taak **${id}** ${taskTitle} waaraan je bent toegewezen, is herhaald en moet opnieuw worden gedaan in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>)`;
            },
            repeat_notification_embed_title(id: string): string {
                return `Taak ${id} herhaald`;
            },
            deadline_alert: "Taakdeadline",
            deadline_duration_due_now: "nu vervalt",
            ...
            commented_notification(guildName: string, guildId: string, author: string, commentText: string): string {
                return `Een reactie is toegevoegd aan een taak in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>) door ${author}: ${commentText}`;
            },
            ...
            subscriber_added_notification(guildName: string, guildId: string, id: string, taskText: string, addedBy: string): string {
                return `Je bent toegevoegd als abonnee van taak **${id}** ${taskText} op werkruimte [${guildName}](<https://discord.com/channels/${guildId}>) door <@${addedBy}>. Je ontvangt meldingen wanneer er iets verandert aan deze taak. Als je geen meldingen meer wilt ontvangen, kun je op de knop hieronder klikken.`;
            },
            ...
            subscriber_notification(guildName: string, guildId: string, id: string, taskTitle: string): string {
                return `De taak **${id}** ${taskTitle} waarop je bent geabonneerd in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>) is gewijzigd:`
            },
            ...
            milestone_due_notification(guildName: string, guildId: string, milestoneName: string): string {
                return `De mijlpaal **${milestoneName}** is binnen 6 uur verschuldigd in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>) en heeft taken die moeten worden voltooid.`;
            },
            status_todo: "Te doen",
        ...
        event: {
            reminderDirectMessage(id: string, name: string, durationTillEventMinutes: number, guildName: string, guildId: string, startTime: string,): string {
                return `Het aankomende evenement (${id}) **${name}** begint over ${durationTillEventMinutes} minuten om ${startTime} in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>).`;
            },
            invite_notification: {
        ...
        files: {
            file_shared_notification(guildName: string, guildId: string, fileName: string, userId: string): string {
                return `Het bestand **${fileName}** is met je gedeeld in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>) door <@${userId}>`;
            },
            folder_shared_notification(guildName: string, guildId: string, folderName: string, userId: string): string {
                return `De map **${folderName}** is met je gedeeld in werkruimte [${guildName}](<https://discord.com/channels/${guildId}>) door <@${userId}>`;
            }
        },
