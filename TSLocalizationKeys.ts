...
import { TSLocalizations_es_mx } from "./es-mx/TSLocalizations_es-mx";
...
import { TSLocalizations_vi_vn } from "./vi-vn/TSLocalizations_vi-vn";
...
export interface TSLocalizationKeys {
    ...
    mails: {
        ...
        ticket_notifications: {
            subject_prefix_new: string,
            subject_prefix_update: string,
            subject_prefix_sla_warning: string,
            ...
            sla_step_first_response: string,
            sla_step_next_response: string,
            sla_step_resolution: string,
            ...
            unknown_inbox_text_without_recipient: string,
            feature_locked_subject: string,
            feature_locked_headline: string,
            feature_locked_text: string,
...
export class Localizations {
    ...
    static Localizations: {
        ...
        "es-mx": TSLocalizations_es_mx.Localizations,
        ...
        "vi-vn": TSLocalizations_vi_vn.Localizations,
        ...
        "id": TSLocalizations_id.Localizations,
    }
}
