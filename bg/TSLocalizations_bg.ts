...
export class TSLocalizations_bg {
    static Localizations: TSLocalizationKeys = {
        ...
        pro_granted_notification(guildId: string, guildName: string): string {
            return `Назначено ви е платено място в работното пространство [${guildName}](<https://discord.com/channels/${guildId}>). Вече имате достъп до функциите, включени във вашето назначено Starter или Pro място.`;
        },
        pro_seat_request_notification(guildId: string, guildName: string, requesterUsername: string): string {
            return `Потребителят **${requesterUsername}** поиска платено място в работното пространство [${guildName}](<https://discord.com/channels/${guildId}>). Администраторите на работното пространство могат да назначат всяко свободно Starter или Pro място с бутона по-долу. Ако работното пространство има нужда от още места, отворете [настройките на работното пространство](<https://bnder.net/app/settings/${guildId}/default?tab=1>), за да купите места.`;
        },
        request_pro_seat_button_label: "Назначи платено място",
        payment_failed_notification(guildId: string, guildName: string, customerPortalLink: string): string {
            return `# 🚨 Необходимо действие: плащането за абонамент за платени места е неуспешно
Не успяхме да обработим плащането за едно или повече Starter или Pro места в [${guildName}](<https://discord.com/channels/${guildId}>). За да не загубите достъпа от платените места, моля [актуализирайте данните си за плащане и платете фактурата сега](<${customerPortalLink}>).

Засегнатите платени места скоро ще спрат да се броят, ако не предприемете действие.
...
Нуждаете се от помощ? [Свържете се с поддръжката](https://bnder.net/discord) — ние сме тук за вас.`;
        ...
        mails: {
            ...
            payment_failed: {
                headline: "🚨 Необходимо действие: плащането за абонамент за платени места е неуспешно",
                text(guildName: string): string {
                    return `Не успяхме да обработим плащането за едно или повече Starter или Pro места в ${guildName}. За да не загубите достъпа от платените места, актуализирайте данните си за плащане и платете фактурата сега. Засегнатите платени места скоро ще спрат да се броят, ако не предприемете действие. Нуждаете се от помощ? Свържете се с поддръжката — ние сме тук за вас.`;
                },
